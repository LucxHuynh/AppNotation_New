...
namespace NotationApp.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task DeleteAccount()
        {
            ...
            //    // Re-authenticate if needed (Firebase requires recent login for deletion)
            //    if (!user.Info.IsRecentLogin)
            //    {
            //        throw new Exception("Please sign in again before deleting your account");
            //    }
            ...
            //    try
            //    {
            //        var userInfo = await _authClient.GetUserAsync(user.Uid);
            //        if (userInfo != null)
            //        {
            //            throw new Exception("Account deletion failed - user still exists");
            //        }
            //    }
            //    catch (FirebaseAuthException)
            //    {
            //        // Expected exception - user was successfully deleted
            //        Console.WriteLine("User deletion verified");
            //    }
            //}
            //catch (Exception ex)
            //{
